...
object ThumbnailConfig {
    ...
    object TimelineThumbs {
        const val FIXED_THUMB_HEIGHT_DP = 60

        /**
         * Calcula (widthDp, heightDp) a partir das dimensões reais do vídeo (já corrigidas por rotação).
         * 
         * Usa uma altura fixa de 60dp para todos os vídeos e calcula a largura dinamicamente
         * com base no aspect ratio (largura = altura * aspect_ratio).
         */
        fun computeDp(videoWidth: Int, videoHeight: Int): Pair<Float, Float> {
            ...
            val heightDp = FIXED_THUMB_HEIGHT_DP.toFloat()
            val widthDp = heightDp * ar
