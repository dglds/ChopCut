...
1. **Protocolo de Sessão:** consulte o arquivo [SESSION_PROTOCOL.md](file:///home/diego/Android/ChopCut/SESSION_PROTOCOL.md) para saber como iniciar, executar e finalizar sua sessão de trabalho. Utilize obrigatoriamente os hooks/skills **/start-session** ao iniciar e **/finish-session** ao finalizar (gerando a nota de progresso `sessions/session#NN-objetivo-da-session.md`).
